    ...
    <div dir="rtl" className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-4xl px-4 py-12">
        ...
        <section className="prose prose-invert mt-10 max-w-none [&_h2]:mt-10 [&_h2]:text-2xl [&_h2]:font-bold [&_p]:my-4 [&_p]:leading-relaxed [&_p]:text-foreground/90 [&_strong]:text-brand-pink">
          <h2>قصتنا</h2>
          <p>
            انطلق <strong>Pixel & Reel</strong> من رؤية بسيطة: السوق الإماراتي يحتاج استوديو سريع، احترافي، ويفهم اللغة العربية والثقافة المحلية. بدأنا في دبي عام 2022، واليوم نخدم عملاء من جميع إمارات الدولة ومن السعودية والكويت.
          </p>
          <p>
