...
export const dict = {
  ...
  faq_q6: { en: "Do you work with startups and small businesses?", ar: "هل تعملون مع الشركات الناشئة والمشاريع الصغيرة؟" },
  faq_a6: { en: "Absolutely — most of our clients are growing brands and small businesses across the UAE.", ar: "بالتأكيد — معظم عملائنا علامات صاعدة ومشاريع صغيرة في جميع أنحاء الإمارات." },
  faq_q7: { en: "Can I order a one-time project without a subscription?", ar: "هل يمكنني طلب مشروع لمرة واحدة بدون اشتراك؟" },
  faq_a7: { en: "Yes. All our services are available as one-time orders via WhatsApp or the contact form.", ar: "نعم. جميع خدماتنا متاحة كطلبات لمرة واحدة عبر واتساب أو نموذج التواصل." },
  faq_q8: { en: "Do you offer revisions?", ar: "هل تقدمون تعديلات؟" },
  faq_a8: { en: "Yes. All plans include at least 2 free revision rounds.", ar: "نعم. جميع الباقات تتضمن جولتين مجانيتين على الأقل من التعديلات." },
  faq_q9: { en: "Which platforms do you design for?", ar: "ما المنصات التي تصممون لها؟" },
  faq_a9: { en: "Instagram, TikTok, Snapchat, X (Twitter), Facebook, and LinkedIn.", ar: "إنستغرام، تيك توك، سناب شات، X (تويتر)، فيسبوك، ولينكدإن." },
  faq_q10: { en: "How do I send my brief?", ar: "كيف أرسل التفاصيل الخاصة بمشروعي؟" },
  faq_a10: { en: "You can WhatsApp us a voice note, text, or images — in Arabic or English.", ar: "يمكنك إرسال ملاحظة صوتية أو نص أو صور عبر واتساب — بالعربية أو الإنجليزية." },
